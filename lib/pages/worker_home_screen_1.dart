...
class WorkerHomeScreen1 extends StatelessWidget {
  const WorkerHomeScreen1({super.key});
    ...
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            margin: const EdgeInsets.fromLTRB(29, 0, 29, 20),
            child: Container(
              decoration: BoxDecoration(
          ...
          Container(
            margin: const EdgeInsets.fromLTRB(29, 0, 29, 5),
            child: Container(
          ...
          SizedBox(
            ...
            height: 44,
            child: SvgPicture.asset(
              'assets/vectors/component_57_x2.svg',
            ),
          ),
        ],
      ),
