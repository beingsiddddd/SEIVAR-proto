...
class TamilWorkerHomeScreen1 extends StatelessWidget {
  const TamilWorkerHomeScreen1({super.key});
          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  margin: const EdgeInsets.fromLTRB(26.8, 0, 0, 41),
                  child: Text(
                    'SEIVAR',
                    style: GoogleFonts.getFont(
                      'Roboto Condensed',
                ...
                Container(
                  margin: const EdgeInsets.fromLTRB(11, 0, 11, 250),
                  child: Align(
                ...
                Container(
                  margin: const EdgeInsets.fromLTRB(29, 0, 29, 1),
                  child: Container(
                ...
                Container(
                  margin: const EdgeInsets.fromLTRB(1, 0, 0, 103),
                  child: SizedBox(
                    width: 210,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                ...
                SizedBox(
                  ...
                  height: 44,
                  child: SvgPicture.asset(
                    'assets/vectors/component_54_x2.svg',
                  ),
                ),
              ],
            ),
